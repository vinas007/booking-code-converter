...
export declare class UnsupportedOperationError extends Error {
    ...
    constructor(operation: string, bookmakerId: BookmakerId);
}
...
export interface BookmakerAdapter {
    ...
    resolveBookingCode(input: ResolveBookingCodeInput): Promise<AdapterOperationResult<BookingCode>>;
    loadSelections(input: LoadSelectionsInput): Promise<AdapterOperationResult<Selection[]>>;
    findEvents(input: FindEventsInput): Promise<AdapterOperationResult<Event[]>>;
    findMarkets(input: FindMarketsInput): Promise<AdapterOperationResult<Market[]>>;
    validateSelections(input: ValidateSelectionsInput): Promise<AdapterOperationResult<boolean>>;
    createBookingCode(input: CreateBookingCodeInput): Promise<AdapterOperationResult<BookingCode>>;
}
